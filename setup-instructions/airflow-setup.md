...
- Start Airflow. (This shall take a few good minutes, grab a coffee!)
  ...
  ```bash
  bash ~/Streamline/scripts/airflow_startup.sh && cd ~/Streamline/airflow
  ```
...
- `streamify_dag`
  - Trigger after `load_songs_dag` to make sure the songs table is available for the transformations
